 ...
 * @author luciano
 */
@WebFilter(filterName = "ProductsFilter", urlPatterns = {"/ProductsManagement/*"})
public class ProductsFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(session==null || (session.getAttribute("currentSessionUser"))==null){
            ...
            if(uri.endsWith("getAll") || uri.endsWith("getProduct") || uri.endsWith("updateProduct") ||
                    uri.endsWith("deleteProduct") || uri.endsWith("addProduct") || uri.endsWith("getMachineProducts") ||
                    uri.endsWith("ProductsManagement")){
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("ProductsFilter(");
